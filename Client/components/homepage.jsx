...
const Homepage = () => {
  ...
  const submitEntry = async (e) => { // good to go
    try {
  ...
  const incognitoToggle = () => {// good to go
    setState(prevState => {
      return {
        ...prevState,
        incognito: !incognito
  ...
  const lastSentenceToggle = () => { // good to go
    setState(prevState => {
        return {
            ...prevState,
            showLast: !showLast
  ...
  const currentSentence = (currValue) => { // good to go
    if (!currValue) return '';
